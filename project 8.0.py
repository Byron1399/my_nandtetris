...
r_n={}
# 检查文件是否存在
with open(b_file_path, 'a', encoding='utf-8') as file_b:
        c=[]
        c.append('@SP')
        c.append('M=0')
        ...
        vm_files = glob.glob(os.path.join(a_dir, "*.vm"))
        for vm_file in vm_files:
            file_name = os.path.basename(vm_file)
            with open(vm_file, 'r') as file_a:
                for line in file_a:
                    ...
                    if processed_line:
                        if processed_line[0]!='//':
                            ...
                            if type=="c_pop" or type=="c_push":
                                if (arg1(processed_line)=='static'):
                                    processed_line[1]=file_name+"_"+processed_line[1]+"_"+processed_line[2]
                                    c = writePushPOP(processed_line[0], arg1(processed_line),'null')
                                else:
